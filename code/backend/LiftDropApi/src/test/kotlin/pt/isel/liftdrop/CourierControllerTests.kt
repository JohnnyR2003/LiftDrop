...
class CourierControllerTests {
    ...
    fun `test WebSocket pickup and dropOff`() {
        ...
        val clientId = createClient(registerClient, LocationDTO(38.80694, -9.189583))
    ...
    @Test
    fun `testing cancel and order by which couriers are chosen`() {
        // Setup WebTestClients
        val courierWebTest = WebTestClient.bindToServer().baseUrl("http://localhost:$port/api/courier").build()
    ...
    @Test
    fun `test courier cancelling and picking up`() {
        // Setup WebTestClients
        val courierWebTest = WebTestClient.bindToServer().baseUrl("http://localhost:$port/api/courier").build()
        ...
        // ─────────────────────────────────────────────────────────────
        // STEP 14: Courier 1 receives confirmation of order
        // ─────────────────────────────────────────────────────────────
        assertTrue(handler.waitForMessage(5000))
        assertNotNull(handler.lastMessage)

        // ─────────────────────────────────────────────────────────────
        // STEP 16: Simulate pickup by courier 1
        // ─────────────────────────────────────────────────────────────
        ...
        // ─────────────────────────────────────────────────────────────
        // STEP 17: Courier 1 cancels the order
        // ─────────────────────────────────────────────────────────────
    ...
    private fun createClient(registerClient: RegisterClientInputModel, locationDTO: LocationDTO): Int = trxManager.run {
            val userId =
